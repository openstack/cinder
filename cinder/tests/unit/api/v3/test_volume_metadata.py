...
class BaseVolumeMetadataTest(test.TestCase):
...
class VolumeMetadataTest(BaseVolumeMetadataTest):
...
class VolumeMetadataTestNoMicroversion(BaseVolumeMetadataTest):
