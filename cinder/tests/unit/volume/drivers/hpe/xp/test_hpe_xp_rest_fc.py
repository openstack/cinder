...
from cinder.volume.drivers.hpe.xp import hpe_xp_fc
...
CONFIG_MAP = {
    ...
    'port_id': 'CL1-A',
    'host_grp_name': 'HPEXP-0123456789abcdef',
...
class HPEXPRESTFCDriverTest(test.TestCase):
    """Unit test class for HPEXP REST interface fibre channel module."""
    ...
    def setUp(self):
        ...
        super(HPEXPRESTFCDriverTest, self).setUp()
    ...
    def _setup_driver(
        ...
        self.driver = hpe_xp_fc.HPEXPFCDriver(
    ...
    def tearDown(self):
        self.client = None
        super(HPEXPRESTFCDriverTest, self).tearDown()
    ...
    @mock.patch.object(hpe_xp_fc.HPEXPFCDriver, "_get_oslo_driver_opts")
