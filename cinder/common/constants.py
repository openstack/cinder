...
# NVMEOF_VARIANTS are generic in that they don't specify the transport
NVMEOF_VARIANTS = [NVMEOF, NVMEOF_VARIANT_1, NVMEOF_VARIANT_2]
# NVMEOF_TRANSPORTS are protocols that DO specify the transport. Due to
# the way the scheduler reports each backend's storage_protocol, these need
# to be maintained in a separate list.
NVMEOF_TRANSPORTS = [NVMEOF_ROCE, NVMEOF_FC, NVMEOF_TCP]
NVMEOF_ALL_PROTOCOLS = NVMEOF_VARIANTS + NVMEOF_TRANSPORTS
